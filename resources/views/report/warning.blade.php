<x-layouts.app>
    ...
    <div class="p-6 print-area">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white">
                    Laporan Dokumen Warning
                </h1>

                <p class="text-gray-500">
                    Data dokumen kapal yang akan expired dalam 30 hari
                </p>

            </div>

            <a href="{{ route('report.warning.print', request()->query()) }}" target="_blank"
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 mb-4">
            ...
            <form method="GET" action="{{ route('report.warning') }}">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-4 overflow-x-auto">
            ...
            <x-data-table :data="$dokumens" paginated>
                ...
                <x-slot name="columns">
                    ...
                    <x-table-column>Tanggal warning</x-table-column>
                ...
                <x-slot name="rows">
                    ...
                    @forelse ($dokumens as $d)
                        <x-table-row>
                            ...
                            <x-table-cell>
                                {{ \Carbon\Carbon::parse($d->tanggal_warning)->translatedFormat('d F Y') }}
                            </x-table-cell>
                    ...
                    @empty
                        ...
                        <x-table-row>
                            ...
                            <td colspan="7" class="px-6 py-6 text-center text-gray-500">
                                ...
                                Tidak ada data dokumen warning.
