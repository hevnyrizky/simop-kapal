...
<head>
    <meta charset="UTF-8">
    <title>Laporan Data Pelabuhan</title>
    ...
    <table class="w-full border border-collapse">
        <thead>
            <tr class="bg-gray-100">
                ...
                <th class="border p-2" width="250">Nama Pelabuhan</th>
                <th class="border p-2" width="200">Lokasi</th>
                <th class="border p-2" width="100">Kode</th>
        ...
        <tbody>
            @forelse ($pelabuhans as $p)
                <tr>
                    ...
                    <td class="border p-2 font-semibold">{{ $p->nama }}</td>
                    <td class="border p-2">{{ $p->lokasi ?? '-' }}</td>
                    <td class="border p-2 text-center font-mono">{{ $p->kode ?? '-' }}</td>
